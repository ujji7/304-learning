...
# If a certain option needs to be frequently set to a value in multiple code chunks, you can consider setting it globally in the first code chunk of your document. Hence over here we set this chunk as a "setup" to make all the to be generated samples consistent.
